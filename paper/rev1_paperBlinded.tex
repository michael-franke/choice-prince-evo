...
For any precise (Bayesian) and identical belief, maximization of expected (objective) utility and minimization of expected regret are behaviorally equivalent. %\citep[e.g.,][]{HalpernPass2012:Iterated-Regret}.
\end{fact}
