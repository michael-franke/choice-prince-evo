...
The standard use of the word \textit{rationality} in economics and decision theory is to denote
the maximization of (subjective) expected utility. Since the work by vNM [cite], this stance
has been justified from the intuitive ''rationality'' of the axioms on the subjective
preference relation leading to the representability of the decision maker as an expected
utility maximizer.
...
\begin{definition}[SEU-maximization] Let $S$ be a set of states of the world, $X$ a set of
  ...
  SEU-maximizing if $a^* \in \text{argmax}_{a_i \in A} \int_S u(a^*(s))dP(s) $.
\end{definition}
