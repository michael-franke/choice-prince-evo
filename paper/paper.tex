...
subject of recent interest (\textcolor{red}{CITE literature on evolution of
  preferences}). Na\"ive intuition might convince us that preferences that veridically
...
$G$. Crucially, this subjective payoff function can be different from the actual payoff in $G$,
which we interpret as the objective fitness. An epistemic state $e_i$ for game $G$ and agent
