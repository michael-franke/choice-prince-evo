...
manner that is consistent with profit maximization will survive in the long run.\todo{@Paolo:
...
\todo[inline]{this section starts off presupposing to much formal stuff for a philosophy
  audience; we should first say why we look at games, then give the definition of a game, then
  define regret, then example, ...}
