...
actual fitness, when agents, at least on occasion, hold imprecise probabilistic beliefs (CITE)
...
The following Section~XYZ will introduce the choice mechanisms that we will focus in on in the
remainder. Section~XYZ details our method of using ``meta-games''. \dots
