...
If an agent does not have a precise probabilistic belief (see also
...
\noindent The acts selected by the maximin rule for the negative regret transformation are exactly
...
expected utility coincides with maximization of expected utility.\\
%Given a player type and an epistemic type, there are different ways to produce a behavior. 
A huge body of experimental literature strongly suggests that agents are generally uncertainty
