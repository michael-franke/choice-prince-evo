...
\begin{tabular}{ccccccccc}
 ...
 & $\tau^{alt}, \Delta(A_{-i})$ \\ 
  \hline
  $\tau^{reg}, \Delta(A_{-i})$ & 6.663 & 6.662 & 5.829 & 7.105 \\ 
  $\tau^{\pi}, \Delta(A_{-i})$ & 6.486 & 6.484 & 6.088 & 6.703 \\ 
  $\tau^{com}, \Delta(A_{-i})$ & 6.323 & 6.758 & 5.496 & 6.977 \\ 
  $\tau^{alt}, \Delta(A_{-i})$ & 5.949 & 5.722 & 5.326 & 6.396 \\ 
   \hline
\end{tabular}
\caption{Average payoff in simulations of 100,000 symmetric $2 \times 2$ games}
...
Finally, Table \ref{tab:Utils-MetaGame2} shows the average fitness when all the epistemic and
player types introduced so far are simultaneously present in the population.
